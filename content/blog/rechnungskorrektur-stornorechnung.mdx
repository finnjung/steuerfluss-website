...
<svg viewBox="0 0 600 170" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Vergleich: Rechnungskorrektur vs. Stornorechnung – Wann welche Methode?" style="max-width:600px;width:100%;height:auto;margin:1.5em 0">
  <style>
  ...
  <text x="0" y="18" class="ct">Rechnungskorrektur vs. Stornorechnung</text>
  <rect x="0" y="26" width="600" height="28" rx="4" fill="#f1f5f9"/>
  <text x="10" y="45" class="th">Situation</text>
  <text x="300" y="45" class="th">Korrektur</text>
  <text x="460" y="45" class="th">Storno</text>
  <line x1="0" y1="58" x2="600" y2="58" stroke="#e2e8f0"/>
  <text x="10" y="75" class="td">Einzelner Fehler (Betrag, Datum)</text>
  <text x="320" y="75" class="yes">✓</text>
  <text x="480" y="75" class="no">–</text>
  <line x1="0" y1="88" x2="600" y2="88" stroke="#e2e8f0"/>
  <text x="10" y="105" class="td">Rechnung bereits bezahlt</text>
  <text x="320" y="105" class="no">–</text>
  <text x="480" y="105" class="yes">✓</text>
  <line x1="0" y1="118" x2="600" y2="118" stroke="#e2e8f0"/>
  <text x="10" y="135" class="td">Auftrag rückabgewickelt</text>
  <text x="320" y="135" class="no">–</text>
  <text x="480" y="135" class="yes">✓</text>
  <line x1="0" y1="148" x2="600" y2="148" stroke="#e2e8f0"/>
  <text x="10" y="165" class="td">Viele Fehler auf einmal</text>
  <text x="320" y="165" class="no">–</text>
  <text x="480" y="165" class="yes">✓</text>
</svg>

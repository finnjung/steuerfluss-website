...
<svg viewBox="0 0 600 100" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Wichtige Steuergrenzen 2026: GWG-Grenze 800 €, Homeoffice-Pauschale 1.260 €, IAB max. 200.000 €" style={{"maxWidth":"600px","width":"100%","height":"auto","margin":"1.5em 0"}}>
  <rect x="0" y="0" width="180" height="90" rx="8" fill="#f9fafb" stroke="#e5e7eb" strokeWidth="1"/>
  <text x="90" y="40" textAnchor="middle" style={{"font":"700 26px -apple-system, system-ui, sans-serif","fill":"#4D719A"}}>800 €</text>
  <text x="90" y="60" textAnchor="middle" style={{"font":"12px -apple-system, system-ui, sans-serif","fill":"#6b7280"}}>GWG-Grenze</text>
  <text x="90" y="76" textAnchor="middle" style={{"font":"12px -apple-system, system-ui, sans-serif","fill":"#6b7280"}}>(Sofortabzug)</text>
  <rect x="210" y="0" width="180" height="90" rx="8" fill="#f9fafb" stroke="#e5e7eb" strokeWidth="1"/>
  <text x="300" y="40" textAnchor="middle" style={{"font":"700 26px -apple-system, system-ui, sans-serif","fill":"#4D719A"}}>1.260 €</text>
  <text x="300" y="60" textAnchor="middle" style={{"font":"12px -apple-system, system-ui, sans-serif","fill":"#6b7280"}}>Homeoffice-</text>
  <text x="300" y="76" textAnchor="middle" style={{"font":"12px -apple-system, system-ui, sans-serif","fill":"#6b7280"}}>Pauschale/Jahr</text>
  <rect x="420" y="0" width="180" height="90" rx="8" fill="#f9fafb" stroke="#e5e7eb" strokeWidth="1"/>
  <text x="510" y="40" textAnchor="middle" style={{"font":"700 26px -apple-system, system-ui, sans-serif","fill":"#4D719A"}}>200.000 €</text>
  <text x="510" y="60" textAnchor="middle" style={{"font":"12px -apple-system, system-ui, sans-serif","fill":"#6b7280"}}>Max. IAB</text>
  <text x="510" y="76" textAnchor="middle" style={{"font":"12px -apple-system, system-ui, sans-serif","fill":"#6b7280"}}>pro Betrieb</text>
</svg>
...
Seit 2023 gilt eine deutlich attraktivere Homeoffice-Pauschale: 6 Euro pro Homeoffice-Tag, maximal 1.260 Euro pro Jahr (entspricht 210 Tagen) nach [§ 4 Abs. 5 Satz 1 Nr. 6c EStG](https://www.gesetze-im-internet.de/estg/__4.html). Du musst dafür kein separates Arbeitszimmer nachweisen – die Pauschale gilt für jeden Tag, an dem du überwiegend von zu Hause aus arbeitest.
...
Weitere Informationen findest du im [BMF-Schreiben vom 15.08.2023 zum Homeoffice](https://www.bundesfinanzministerium.de/Content/DE/Downloads/BMF_Schreiben/Steuerarten/Einkommensteuer/2023-08-17-ertragsteuerliche-beurteilung-der-betrieblichen-und-beruflichen-betaetigung-in-der-haeuslichen-wohnung.pdf?__blob=publicationFile&v=2).
...
**Geringwertige Wirtschaftsgüter (GWG):** Anschaffungen bis 800 Euro netto kannst du nach [§ 6 Abs. 2 EStG](https://www.gesetze-im-internet.de/estg/__6.html) sofort und vollständig im Jahr des Kaufs absetzen. Das gilt für Stühle, Monitore, Headsets und ähnliches.

**Lineare AfA:** Gleichmäßige Verteilung der Kosten über die Nutzungsdauer nach [§ 7 Abs. 1 EStG](https://www.gesetze-im-internet.de/estg/__7.html). Ein MacBook (Anschaffungswert 2.000 €) wird nach der AfA-Tabelle auf 3 Jahre abgeschrieben → 667 € pro Jahr.

**Degressive AfA:** Ab April 2024 (Wachstumschancengesetz) wieder eingeführt, zunächst mit max. 20 % (doppelter linearer Satz) nach [§ 7 Abs. 2 EStG](https://www.gesetze-im-internet.de/estg/__7.html). Für Wirtschaftsgüter, die ab dem 1. Juli 2025 angeschafft werden, gilt ein erhöhter Satz von max. 30 % (dreifacher linearer Satz) – gültig bis 31. Dezember 2027 (steuerliches Investitionssofortprogramm). Höherer Abzug in den ersten Jahren, sinkend danach. Attraktiv bei Gütern mit schnellem Wertverlust.
...
Seit 2025 gilt eine erhöhte Umsatzgrenze für die Kleinunternehmerregelung nach [§ 19 UStG](https://www.gesetze-im-internet.de/ustg_1980/__19.html): 25.000 Euro Umsatz im Vorjahr (vorher 22.000 Euro). Diese Grenzen gelten auch 2026 weiter. Wenn dein Umsatz darunterliegt, musst du keine Umsatzsteuer erheben und ans Finanzamt abführen.
...
**IST-Versteuerung:** Die Steuer wird erst bei Zahlungseingang fällig. Das schont die Liquidität enorm. Bedingung: Du musst einen Antrag beim Finanzamt stellen und darfst bestimmte Umsatzgrenzen nicht überschreiten (seit 01.01.2024: 800.000 Euro, [§ 20 UStG](https://www.gesetze-im-internet.de/ustg_1980/__20.html)).
...
Als EÜR-Rechner (Einnahmen-Überschuss-Rechnung) gilt das [Zufluss-Abfluss-Prinzip nach § 11 EStG](https://www.gesetze-im-internet.de/estg/__11.html): Einnahmen zählen im Jahr des Eingangs, Ausgaben im Jahr der Zahlung. Das gibt dir Gestaltungsspielraum:
...
**Rürup-Rente (Basisrente):** 2026 kannst du als Single bis zu 30.826 Euro (Verheiratete: 61.652 Euro) als [Sonderausgaben nach § 10 Abs. 1 Nr. 2 EStG](https://www.gesetze-im-internet.de/estg/__10.html) abziehen. Der Abzug ist zu 100 % wirksam. Bei einem Grenzsteuersatz von 42 % bedeutet das bei voller Ausschöpfung eine Steuerersparnis von über 12.900 Euro.
...
**Kundengeschenke:** Seit 2024 liegt die Grenze bei 50 Euro pro Person und Jahr ([§ 4 Abs. 5 Nr. 1 EStG](https://www.gesetze-im-internet.de/estg/__4.html), netto, ohne Mehrwertsteuer). Was darüber liegt, ist privat. Wichtig: Das Geschenk muss auf einem separaten Konto gebucht werden (Sammelposten), damit das Finanzamt keine Nachfragen stellt.
...
**Sachzuwendungen an Mitarbeiter:** Falls du Angestellte hast – Sachleistungen bis 50 Euro pro Mitarbeiter und Monat sind nach [§ 8 Abs. 2 Satz 11 EStG](https://www.gesetze-im-internet.de/estg/__8.html) steuer- und sozialabgabenfrei. Das können Tankgutscheine, Einkaufsgutscheine oder andere Sachleistungen sein (kein Bargeld).
...
Mit [SteuerFluss kostenlos ausprobieren](https://app.steuer-fluss.de) hast du jederzeit den Überblick über deine Einnahmen, Ausgaben und deine steuerliche Situation – und kannst mit deinem Steuerberater auf Augenhöhe sprechen. Weitere Grundlagen: [Einnahmen-Überschuss-Rechnung (EÜR) erklärt](/blog/eur-einnahmen-ueberschuss-rechnung) · [Rechnungen korrekt schreiben nach § 14 UStG](/blog/rechnung-richtig-schreiben) · [Umsatzsteuer-Voranmeldung: Schritt-für-Schritt](/blog/umsatzsteuer-voranmeldung) · [Gewerbesteuer für Gewerbetreibende erklärt](/blog/gewerbesteuer-selbststaendige) · [Investitionsabzugsbetrag (IAB): Vor der Anschaffung Steuern sparen](/blog/investitionsabzugsbetrag-iab)

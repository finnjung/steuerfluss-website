...
<svg viewBox="0 0 600 100" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Wichtige Steuergrenzen 2026: GWG-Grenze 800 €, Homeoffice-Pauschale 1.260 €, IAB max. 200.000 €" style="max-width:600px;width:100%;height:auto;margin:1.5em 0">
  <style>
    .st-num { font: 700 26px -apple-system, system-ui, sans-serif; fill: #4D719A; }
    .st-label { font: 12px -apple-system, system-ui, sans-serif; fill: #6b7280; }
  </style>
  <rect x="0" y="0" width="180" height="90" rx="8" fill="#f9fafb" stroke="#e5e7eb" stroke-width="1"/>
  <text x="90" y="40" text-anchor="middle" class="st-num">800 €</text>
  <text x="90" y="60" text-anchor="middle" class="st-label">GWG-Grenze</text>
  <text x="90" y="76" text-anchor="middle" class="st-label">(Sofortabzug)</text>
  <rect x="210" y="0" width="180" height="90" rx="8" fill="#f9fafb" stroke="#e5e7eb" stroke-width="1"/>
  <text x="300" y="40" text-anchor="middle" class="st-num">1.260 €</text>
  <text x="300" y="60" text-anchor="middle" class="st-label">Homeoffice-</text>
  <text x="300" y="76" text-anchor="middle" class="st-label">Pauschale/Jahr</text>
  <rect x="420" y="0" width="180" height="90" rx="8" fill="#f9fafb" stroke="#e5e7eb" stroke-width="1"/>
  <text x="510" y="40" text-anchor="middle" class="st-num">200.000 €</text>
  <text x="510" y="60" text-anchor="middle" class="st-label">Max. IAB</text>
  <text x="510" y="76" text-anchor="middle" class="st-label">pro Betrieb</text>
</svg>

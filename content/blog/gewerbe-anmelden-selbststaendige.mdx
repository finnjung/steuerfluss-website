...
**Freiberufler** (z. B. Ärzte, Rechtsanwälte, Architekten, Journalisten, Ingenieure) müssen dagegen **kein Gewerbe anmelden** – sie melden sich nur beim Finatsamt über den [Fragebogen zur steuerlichen Erfassung](https://www.steuer-fluss.de/blog/steuernummer-beantragen). Das ist ein häufiger Fehler, den es zu vermeiden gilt.

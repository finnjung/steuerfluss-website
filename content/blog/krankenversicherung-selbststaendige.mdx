...
<svg viewBox="0 0 600 110" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="GKV-Kennzahlen 2026: Mindestbemessungsgrundlage 1.318 Euro, Beitragsbemessungsgrenze 5.813 Euro, GKV-Höchstbeitrag 1.261 Euro monatlich" style="max-width:600px;width:100%;height:auto;margin:1.5em 0">
  <style>
    .sn { font: 700 22px -apple-system, system-ui, sans-serif; fill: #4D719A; }
    .sl { font: 12px -apple-system, system-ui, sans-serif; fill: #6b7280; }
  </style>
  <rect x="0" y="0" width="185" height="100" rx="8" fill="#f9fafb" stroke="#e5e7eb" stroke-width="1"/>
  <text x="92" y="42" text-anchor="middle" class="sn">1.318 €</text>
  <text x="92" y="62" text-anchor="middle" class="sl">Mindest-</text>
  <text x="92" y="78" text-anchor="middle" class="sl">bemessungsgrundlage/Monat</text>
  <rect x="207" y="0" width="185" height="100" rx="8" fill="#f9fafb" stroke="#e5e7eb" stroke-width="1"/>
  <text x="300" y="42" text-anchor="middle" class="sn">5.813 €</text>
  <text x="300" y="62" text-anchor="middle" class="sl">Beitrags-</text>
  <text x="300" y="78" text-anchor="middle" class="sl">bemessungsgrenze/Monat</text>
  <rect x="414" y="0" width="185" height="100" rx="8" fill="#f9fafb" stroke="#e5e7eb" stroke-width="1"/>
  <text x="507" y="42" text-anchor="middle" class="sn">1.261 €</text>
  <text x="507" y="62" text-anchor="middle" class="sl">GKV-Höchstbeitrag</text>
  <text x="507" y="78" text-anchor="middle" class="sl">(KV+PV, kinderlos)/Monat</text>
</svg>

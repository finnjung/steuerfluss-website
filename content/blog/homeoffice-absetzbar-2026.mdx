...
<svg viewBox="0 0 600 200" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Vergleich Homeoffice-Pauschale vs. häusliches Arbeitszimmer: Pauschale max. 1.260 Euro, kein eigenes Zimmer nötig; Arbeitszimmer unbegrenzt, eigenes Zimmer erforderlich" style="max-width:600px;width:100%;height:auto;margin:1.5em 0">
  <style>
    .ho-title { font: 700 14px -apple-system, system-ui, sans-serif; fill: #171717; }
    .ho-val { font: 700 22px -apple-system, system-ui, sans-serif; fill: #4D719A; }
    .ho-label { font: 12px -apple-system, system-ui, sans-serif; fill: #6b7280; }
    .ho-check { font: 14px -apple-system, system-ui, sans-serif; fill: #16a34a; }
    .ho-cross { font: 14px -apple-system, system-ui, sans-serif; fill: #dc2626; }
  </style>
  <rect x="0" y="0" width="280" height="190" rx="8" fill="#f9fafb" stroke="#e5e7eb" stroke-width="1"/>
  <text x="140" y="30" text-anchor="middle" class="ho-title">Homeoffice-Pauschale</text>
  <text x="140" y="68" text-anchor="middle" class="ho-val">max. 1.260 €</text>
  <text x="140" y="90" text-anchor="middle" class="ho-label">6 € × 210 Tage</text>
  <text x="30" y="120" class="ho-check">&#10003; Kein eigenes Zimmer nötig</text>
  <text x="30" y="142" class="ho-check">&#10003; Keine Belege erforderlich</text>
  <text x="30" y="164" class="ho-cross">&#10007; Betrag gedeckelt</text>
  <rect x="320" y="0" width="280" height="190" rx="8" fill="#f9fafb" stroke="#4D719A" stroke-width="2"/>
  <text x="460" y="30" text-anchor="middle" class="ho-title">Häusliches Arbeitszimmer</text>
  <text x="460" y="68" text-anchor="middle" class="ho-val">unbegrenzt</text>
  <text x="460" y="90" text-anchor="middle" class="ho-label">Tatsächliche Kosten</text>
  <text x="350" y="120" class="ho-check">&#10003; Höherer Abzug möglich</text>
  <text x="350" y="142" class="ho-cross">&#10007; Eigenes Zimmer nötig</text>
  <text x="350" y="164" class="ho-cross">&#10007; Mittelpunkt der Tätigkeit</text>
</svg>

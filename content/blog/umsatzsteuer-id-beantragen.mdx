...
<svg viewBox="0 0 600 100" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="USt-IdNr. auf einen Blick: kostenlos, 2 bis 6 Wochen Bearbeitungszeit, Format DE + 9 Ziffern" style="max-width:600px;width:100%;height:auto;margin:1.5em 0">
  <style>
  ...
  <text x="90" y="38" text-anchor="middle" class="sn">kostenlos</text>
  <text x="90" y="60" text-anchor="middle" class="sl">Antrag beim BZSt</text>
  <rect x="200" y="0" width="180" height="90" rx="8" fill="#f9fafb" stroke="#e5e7eb" stroke-width="1"/>
  <text x="290" y="38" text-anchor="middle" class="sn">2–6 Wochen</text>
  <text x="290" y="60" text-anchor="middle" class="sl">Bearbeitungszeit</text>
  <rect x="400" y="0" width="180" height="90" rx="8" fill="#f9fafb" stroke="#e5e7eb" stroke-width="1"/>
  <text x="490" y="38" text-anchor="middle" class="sn">DE + 9 Ziffern</text>
  <text x="490" y="60" text-anchor="middle" class="sl">Format in Deutschland</text>
</svg>

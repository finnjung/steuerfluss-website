...
<svg viewBox="0 0 620 110" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Vier Vorauszahlungstermine im Jahr: 10. März, 10. Juni, 10. September, 10. Dezember" style={{maxWidth:"620px",width:"100%",height:"auto",margin:"1.5em 0"}}>
  <text x="10" y="18" fontSize="14" fontWeight="600" fontFamily="-apple-system, system-ui, sans-serif" fill="#111827">Fälligkeitstermine Einkommensteuer-Vorauszahlung</text>
  {/* Q1 */}
  <rect x="10" y="32" width="130" height="60" rx="6" fill="#f0f4f9" stroke="#4D719A" strokeWidth="1.5"/>
  <text x="75" y="55" textAnchor="middle" fontSize="13" fontWeight="600" fontFamily="-apple-system, system-ui, sans-serif" fill="#4D719A">Q1</text>
  <text x="75" y="73" textAnchor="middle" fontSize="12" fontFamily="-apple-system, system-ui, sans-serif" fill="#6b7280">10. März</text>
  {/* Q2 */}
  <rect x="165" y="32" width="130" height="60" rx="6" fill="#f0f4f9" stroke="#4D719A" strokeWidth="1.5"/>
  <text x="230" y="55" textAnchor="middle" fontSize="13" fontWeight="600" fontFamily="-apple-system, system-ui, sans-serif" fill="#4D719A">Q2</text>
  <text x="230" y="73" textAnchor="middle" fontSize="12" fontFamily="-apple-system, system-ui, sans-serif" fill="#6b7280">10. Juni</text>
  {/* Q3 */}
  <rect x="320" y="32" width="130" height="60" rx="6" fill="#f0f4f9" stroke="#4D719A" strokeWidth="1.5"/>
  <text x="385" y="55" textAnchor="middle" fontSize="13" fontWeight="600" fontFamily="-apple-system, system-ui, sans-serif" fill="#4D719A">Q3</text>
  <text x="385" y="73" textAnchor="middle" fontSize="12" fontFamily="-apple-system, system-ui, sans-serif" fill="#6b7280">10. September</text>
  {/* Q4 */}
  <rect x="475" y="32" width="130" height="60" rx="6" fill="#f0f4f9" stroke="#4D719A" strokeWidth="1.5"/>
  <text x="540" y="55" textAnchor="middle" fontSize="13" fontWeight="600" fontFamily="-apple-system, system-ui, sans-serif" fill="#4D719A">Q4</text>
  <text x="540" y="73" textAnchor="middle" fontSize="12" fontFamily="-apple-system, system-ui, sans-serif" fill="#6b7280">10. Dezember</text>
</svg>

...
<svg viewBox="0 0 600 100" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Drei Kennzahlen zum Vorsteuerabzug: § 15 UStG als Rechtsgrundlage, 19 Prozent Regelsteuersatz, 7 Prozent ermäßigter Steuersatz" style={{maxWidth:'600px',width:'100%',height:'auto',margin:'1.5em 0'}}>

  <rect x="0" y="0" width="180" height="90" rx="8" fill="#f9fafb" stroke="#e5e7eb" stroke-width="1"/>
  <text x="90" y="40" text-anchor="middle" font-weight="700" font-size="26px" font-family="-apple-system, system-ui, sans-serif" fill="#4D719A">§ 15</text>
  <text x="90" y="58" text-anchor="middle" font-size="12px" font-family="-apple-system," fill="#6b7280">UStG – Rechtsgrundlage</text>
  <text x="90" y="74" text-anchor="middle" font-size="12px" font-family="-apple-system," fill="#6b7280">Vorsteuerabzug</text>
  <rect x="210" y="0" width="180" height="90" rx="8" fill="#f9fafb" stroke="#e5e7eb" stroke-width="1"/>
  <text x="300" y="40" text-anchor="middle" font-weight="700" font-size="26px" font-family="-apple-system, system-ui, sans-serif" fill="#4D719A">19 %</text>
  <text x="300" y="58" text-anchor="middle" font-size="12px" font-family="-apple-system," fill="#6b7280">Regelsteuersatz</text>
  <text x="300" y="74" text-anchor="middle" font-size="12px" font-family="-apple-system," fill="#6b7280">(z. B. Dienstleistungen, Elektronik)</text>
  <rect x="420" y="0" width="180" height="90" rx="8" fill="#f9fafb" stroke="#e5e7eb" stroke-width="1"/>
  <text x="510" y="40" text-anchor="middle" font-weight="700" font-size="26px" font-family="-apple-system, system-ui, sans-serif" fill="#4D719A">7 %</text>
  <text x="510" y="58" text-anchor="middle" font-size="12px" font-family="-apple-system," fill="#6b7280">Ermäßigter Satz</text>
  <text x="510" y="74" text-anchor="middle" font-size="12px" font-family="-apple-system," fill="#6b7280">(z. B. Bücher, Lebensmittel)</text>
</svg>
...
**Hinweis zu ausländischen Rechnungen:** Nutzt du Tools wie Adobe Creative Cloud, Slack oder Google Workspace, stellen diese Anbieter (mit Sitz im EU-Ausland) Rechnungen häufig ohne deutsche Umsatzsteuer aus. Du schuldest die Steuer in diesem Fall selbst – das nennt sich [Reverse Charge](https://steuer-fluss.de/blog/reverse-charge-selbststaendige) (Umkehr der Steuerschuldnerschaft). Diese selbst berechnete Steuer kannst du im selben Voranmeldungszeitraum als Vorsteuer geltend machen – wenn du zum Vorsteuerabzug berechtigt bist. Das Ergebnis ist in der Regel null, aber der Vorgang muss korrekt gemeldet werden.

...
<svg viewBox="0 0 600 190" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Kleinunternehmerregelung: Alte Grenzen bis 2024 (22.000 Euro Vorjahr, 50.000 Euro laufendes Jahr) vs. neue Grenzen ab 2025 (25.000 Euro Vorjahr, 100.000 Euro laufendes Jahr)" style="max-width:600px;width:100%;height:auto;margin:1.5em 0">
  <style>
    .ku-title { font: 700 13px -apple-system, system-ui, sans-serif; fill: #171717; }
    .ku-label { font: 12px -apple-system, system-ui, sans-serif; fill: #6b7280; }
    .ku-val { font: 700 13px -apple-system, system-ui, sans-serif; fill: #ffffff; }
    .ku-cat { font: 12px -apple-system, system-ui, sans-serif; fill: #171717; }
  </style>
  <text x="0" y="18" class="ku-title">Vorjahresumsatz</text>
  <text x="0" y="48" class="ku-label">Bis 2024</text>
  <rect x="100" y="33" width="132" height="22" rx="4" fill="#95B8E8"/>
  <text x="110" y="49" class="ku-val">22.000 €</text>
  <text x="0" y="78" class="ku-label">Ab 2025</text>
  <rect x="100" y="63" width="150" height="22" rx="4" fill="#4D719A"/>
  <text x="110" y="79" class="ku-val">25.000 €</text>
  <text x="0" y="118" class="ku-title">Umsatz im laufenden Jahr</text>
  <text x="0" y="148" class="ku-label">Bis 2024</text>
  <rect x="100" y="133" width="250" height="22" rx="4" fill="#95B8E8"/>
  <text x="110" y="149" class="ku-val">50.000 €</text>
  <text x="0" y="178" class="ku-label">Ab 2025</text>
  <rect x="100" y="163" width="500" height="22" rx="4" fill="#4D719A"/>
  <text x="110" y="179" class="ku-val">100.000 € (harte Grenze)</text>
</svg>

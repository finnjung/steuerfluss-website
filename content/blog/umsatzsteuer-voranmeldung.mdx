...
<svg viewBox="0 0 600 160" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="UStVA-Abgabefristen 2026: Q1 bis 10. April, Q2 bis 10. Juli, Q3 bis 10. Oktober, Q4 bis 10. Januar 2027" style="max-width:600px;width:100%;height:auto;margin:1.5em 0">
  <style>
    .tl-q { font: 700 14px -apple-system, system-ui, sans-serif; fill: #ffffff; }
    .tl-period { font: 12px -apple-system, system-ui, sans-serif; fill: #6b7280; }
    .tl-date { font: 700 13px -apple-system, system-ui, sans-serif; fill: #4D719A; }
    .tl-label { font: 11px -apple-system, system-ui, sans-serif; fill: #6b7280; }
  </style>
  <line x1="30" y1="40" x2="570" y2="40" stroke="#e5e7eb" stroke-width="2"/>
  <circle cx="90" cy="40" r="18" fill="#4D719A"/><text x="90" y="45" text-anchor="middle" class="tl-q">Q1</text>
  <text x="90" y="72" text-anchor="middle" class="tl-period">Jan–Mrz</text>
  <text x="90" y="90" text-anchor="middle" class="tl-date">10. Apr 2026</text>
  <circle cx="230" cy="40" r="18" fill="#4D719A"/><text x="230" y="45" text-anchor="middle" class="tl-q">Q2</text>
  <text x="230" y="72" text-anchor="middle" class="tl-period">Apr–Jun</text>
  <text x="230" y="90" text-anchor="middle" class="tl-date">10. Jul 2026</text>
  <circle cx="370" cy="40" r="18" fill="#4D719A"/><text x="370" y="45" text-anchor="middle" class="tl-q">Q3</text>
  <text x="370" y="72" text-anchor="middle" class="tl-period">Jul–Sep</text>
  <text x="370" y="90" text-anchor="middle" class="tl-date">10. Okt 2026</text>
  <circle cx="510" cy="40" r="18" fill="#4D719A"/><text x="510" y="45" text-anchor="middle" class="tl-q">Q4</text>
  <text x="510" y="72" text-anchor="middle" class="tl-period">Okt–Dez</text>
  <text x="510" y="90" text-anchor="middle" class="tl-date">10. Jan 2027</text>
  <text x="300" y="130" text-anchor="middle" class="tl-label">Mit Dauerfristverlängerung: jeweils +1 Monat Aufschub</text>
</svg>

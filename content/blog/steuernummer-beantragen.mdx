...
Seit dem 1. Januar 2021 muss der Antrag [**elektronisch über ELSTER**](https://www.elster.de/elsterweb/infoseite/unternehmensgruendung) eingereicht werden – per Post ist nicht mehr zulässig.
...
Die Steuernummer (z.B. 12/345/67890) vergeben die Finanzämter lokal und kann sich ändern. Die [Umsatzsteuer-Identifikationsnummer (USt-IdNr., z.B. DE123456789)](https://www.bzst.de/DE/Business/UID/uid_node.html) ist bundesweit eindeutig und für grenzüberschreitende EU-Geschäfte notwendig – beantrage sie beim [Bundeszentralamt für Steuern (BZSt)](https://www.bzst.de), aber erst nachdem du eine Steuernummer hast.

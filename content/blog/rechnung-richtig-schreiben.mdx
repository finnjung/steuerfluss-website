...
<svg viewBox="0 0 600 220" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Die 7 Pflichtangaben auf einer Rechnung nach § 14 UStG: Name und Anschrift, Steuernummer, Rechnungsdatum, Rechnungsnummer, Leistungsbeschreibung, Leistungsdatum, Beträge und Steuer" style="max-width:600px;width:100%;height:auto;margin:1.5em 0">
  <style>
    .re-title { font: 700 14px -apple-system, system-ui, sans-serif; fill: #171717; }
    .re-num { font: 700 14px -apple-system, system-ui, sans-serif; fill: #ffffff; }
    .re-item { font: 13px -apple-system, system-ui, sans-serif; fill: #171717; }
  </style>
  <text x="300" y="20" text-anchor="middle" class="re-title">7 Pflichtangaben auf jeder Rechnung (§ 14 UStG)</text>
  <circle cx="25" cy="52" r="12" fill="#4D719A"/><text x="25" y="57" text-anchor="middle" class="re-num">1</text>
  <text x="45" y="57" class="re-item">Name + Anschrift (Leistender und Empfänger)</text>
  <circle cx="25" cy="82" r="12" fill="#4D719A"/><text x="25" y="87" text-anchor="middle" class="re-num">2</text>
  <text x="45" y="87" class="re-item">Steuernummer oder USt-IdNr.</text>
  <circle cx="25" cy="112" r="12" fill="#4D719A"/><text x="25" y="117" text-anchor="middle" class="re-num">3</text>
  <text x="45" y="117" class="re-item">Ausstellungsdatum der Rechnung</text>
  <circle cx="25" cy="142" r="12" fill="#4D719A"/><text x="25" y="147" text-anchor="middle" class="re-num">4</text>
  <text x="45" y="147" class="re-item">Fortlaufende Rechnungsnummer</text>
  <circle cx="325" cy="52" r="12" fill="#4D719A"/><text x="325" y="57" text-anchor="middle" class="re-num">5</text>
  <text x="345" y="57" class="re-item">Leistungsbeschreibung</text>
  <circle cx="325" cy="82" r="12" fill="#4D719A"/><text x="325" y="87" text-anchor="middle" class="re-num">6</text>
  <text x="345" y="87" class="re-item">Leistungsdatum / -zeitraum</text>
  <circle cx="325" cy="112" r="12" fill="#4D719A"/><text x="325" y="117" text-anchor="middle" class="re-num">7</text>
  <text x="345" y="117" class="re-item">Netto, Steuersatz, Steuer, Brutto</text>
  <rect x="10" y="170" width="580" height="40" rx="6" fill="#f9fafb" stroke="#e5e7eb" stroke-width="1"/>
  <text x="300" y="195" text-anchor="middle" style="font: 12px -apple-system, system-ui, sans-serif; fill: #6b7280;">Kleinbetragsrechnungen bis 250 € brutto: vereinfachte Anforderungen (§ 33 UStDV)</text>
</svg>
